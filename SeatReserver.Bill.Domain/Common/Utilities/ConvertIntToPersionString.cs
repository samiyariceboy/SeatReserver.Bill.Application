using System;
namespace SeatReserver.Bill.Domain.Common.Utilities
{
    public static class ConvertIntToPersionString
    {
        public static string ConvertToPersionString(this int TXT)
        {
            string RET = " ", STRVA = " ";
            string[] MainStr = STR_To_Int(TXT.ToString());
            int Q = 0;
